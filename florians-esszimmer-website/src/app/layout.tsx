...
const SITE_URL = "https://florians-esszimmer-website.vercel.app";
...
const description =
  "Kleines, feines Restaurant in der Lemgoer Altstadt (Mittelstraße 100). Saisonale, regionale Küche, begleitet von Spirituosen der Gutshof Brennerei Begatal. 4,8★. Reservierung: 01515 2495659.";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: { default: title, template: "%s · Florian's Esszimmer Lemgo" },
  description,
  keywords: [
    "Restaurant Lemgo",
    "essen gehen Lemgo",
  ...
  openGraph: { type: "website", locale: "de_DE", url: "/", siteName: "Florian's Esszimmer", title, description },
...
const jsonLd = {
  ...
  aggregateRating: { "@type": "AggregateRating", ratingValue: "4.8", reviewCount: "46", bestRating: "5" },
